<?php
	...
	$sql1= "SELECT CorrectAnswer1 FROM dc WHERE SlNo like 1";
	...
	$sql1= "SELECT CorrectAnswer1 FROM dc WHERE SlNo like 2";
	$result = mysqli_query($conn, $sql1);
	...
	$sql1= "SELECT CorrectAnswer1 FROM dc WHERE SlNo like 3";
	$result = mysqli_query($conn, $sql1);
	...
	$sql1= "SELECT CorrectAnswer1 FROM dc WHERE SlNo like 4";
	$result = mysqli_query($conn, $sql1);
	...
	$sql1= "SELECT CorrectAnswer1 FROM dc WHERE SlNo like 5";
	$result = mysqli_query($conn, $sql1);
	...
	$sql1= "SELECT CorrectAnswer1 FROM dc WHERE SlNo like 6";
	$result = mysqli_query($conn, $sql1);
	...
	$sql1= "SELECT CorrectAnswer1 FROM dc WHERE SlNo like 7";
	$result = mysqli_query($conn, $sql1);
	...
	$sql1= "SELECT CorrectAnswer1 FROM dc WHERE SlNo like 8";
	$result = mysqli_query($conn, $sql1);
	...
	$sql1= "SELECT CorrectAnswer1 FROM dc WHERE SlNo like 9";
	$result = mysqli_query($conn, $sql1);
	...
	$sql1= "SELECT CorrectAnswer1 FROM dc WHERE SlNo like 10";
	$result = mysqli_query($conn, $sql1);
	...
	$sql2="SELECT Score,dcScore FROM info WHERE SlNo LIKE $sl";
	...
	if(mysqli_num_rows($result)>0)
	{
		...
		$mark=$mark+$count;
		$dcscore=$row['dcScore'];
		$dcscore=$dcscore+$count;
	}
	$sql="UPDATE info SET Score=$mark,dcScore=$dcscore WHERE SlNo=$sl";
