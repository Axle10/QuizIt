<?php
	...
	{
		case '/Projects/QuizIt/HarryPotterInstruction.php':
			$link = 'HarryPotterQuiz1.php';
		break;
		
		case '/Projects/QuizIt/FIFAInstruction.php':
			$link = 'FIFAQuiz1.php';
		break;

		case '/Projects/QuizIt/DCInstruction.php':
			$link = 'DCQuiz1.php';
		break;

		case '/Projects/QuizIt/MarvelInstruction.php':
			$link = 'MarvelQuiz1.php';
		break;
	}
?>
<!DOCTYPE html>
<html>
	...
	<body>
		...
		<center>
			...
			<h3>
				<a href="<?php echo $link; ?>"><button type="submit" class="btn">
					Go For Test
